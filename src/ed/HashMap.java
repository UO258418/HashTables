...
/*public class HashMap<T, V> {
    ...
    private int probing;
    private List<HashMapNode> associativeArray;
    private int numOfElements = 0;

    public HashMap(int B, int probing, double maxLoadFactor) {
        this.B = B;
    ...
    public HashMap(int B, int probing, double maxLoadFactor, double minLoadFactor) {
        this(B, probing, maxLoadFactor);
        this.minLoadFactor = minLoadFactor;
    }

    private void init(List<HashMapNode> array) {
        for(int i = 0; i < B; i++) {
            HashMapNode<T, V> node = new HashMapNode<>();
    ...
    private void dynamicResize(int newSize) {
       HashMap<T> aux = new HashMap<>(newSize, probing, maxLoadFactor);
